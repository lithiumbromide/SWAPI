---
title: "api/{vaultName}/files/{fileId}/{version}/download (Get)"
project: ""
interface: "r-api-{vaultName}-files-{fileId}-{version}-download"
member: "o-HttpGet"
kind: "topic"
source: "pdmprowebapihelp/PDM Pro API_ws~r-api-{vaultName}-files-{fileId}-{version}-download~o-HttpGet.html"
---

# api/{vaultName}/files/{fileId}/{version}/download (Get)
...
| PDM Pro API Web Service > File Resource Group : api/{vaultName}/files/{fileId}/{version}/download (Get) |
| --- |
