---
title: "api/{vaultName}/files/{fileId}/{version} (Get)"
project: ""
interface: "r-api-{vaultName}-files-{fileId}-{version}"
member: "o-HttpGet"
kind: "topic"
source: "pdmprowebapihelp/PDM Pro API_ws~r-api-{vaultName}-files-{fileId}-{version}~o-HttpGet.html"
---

# api/{vaultName}/files/{fileId}/{version} (Get)
...
| PDM Pro API Web Service > File Resource Group : api/{vaultName}/files/{fileId}/{version} (Get) |
| --- |
...
| fileId | (URI and Response parameter) File ID (required) | integer |
| version | (URI parameter) Version (default value is 0) | integer |
...
[
  {
    ...
    "Size": 3,
    "ModifiedDate": "2022-07-25T14:02:49.4654054-04:00",
    "Version": 5,
...
<ArrayOfObjectInfo xmlns:i="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://schemas.datacontract.org/2004/07/SWPDM.Models">
  <ObjectInfo>
    ...
    <ModifiedDate>2022-07-25T14:02:49.4654054-04:00</ModifiedDate>
