---
title: "IConvertSolidFeatureData Interface"
project: "SOLIDWORKS API Help"
interface: "IConvertSolidFeatureData"
member: ""
kind: "interface"
source: "sldworksapi/SolidWorks.Interop.sldworks~SolidWorks.Interop.sldworks.IConvertSolidFeatureData.html"
---
...
[ConvertSolidFeatureData](ms-its:sldworksapivb6.chm::/sldworks~ConvertSolidFeatureData.html)
...
2. Call
  ...
  to select the fixed face (with Mark=0) and bend edges (with Mark=1).
3. Call
  ...
  (swFmSolidToSheetMetal) to create this feature data object.
4. Instantiate and specify the
...
6. Call
  ...
  to create the ConvertSolid feature.
...
[ConvertSolidFeatureData](SWObjectModel.pdf#ConvertSolidFeatureData)
