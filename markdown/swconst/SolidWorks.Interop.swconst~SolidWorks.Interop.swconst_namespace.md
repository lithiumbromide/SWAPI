---
title: "SolidWorks.Interop.swconst Namespace"
project: "SOLIDWORKS API Enumerations"
interface: "SolidWorks.Interop.swconst"
member: ""
kind: "namespace"
source: "swconst/SolidWorks.Interop.swconst~SolidWorks.Interop.swconst_namespace.html"
---
...
| sw3DExperienceModelType_e | Types of 3D EXPERIENCE component icons. |
| sw3DExperienceState_e | SOLIDWORKS Connected states. Bitmask . |
...
| swAddToRecentDocumentList_e | Recent Documents list actions for a document opened using ISldWorks::OpenDoc7 and IDocumentSpecification::AddToRecentDocumentList . |
...
| swCADFamilyCfgOptions_e | SOLIDWORKS CONNECTED family configuration options. Bitmask . |
...
| swCheckClearanceBetween_e | Between options for clearance verification. |
...
| swCollinearChainDimArrowHeadStyle_e | Collinear chain dimension arrow head styles. |
...
| swComponentIdentifier_e | Component display options for the FeatureManager design tree. Bitmask . |
...
| swCornerReliefSuitCaseType_e | Sheet metal corner relief suitcase types. |
| swCornerReliefType_e | Corner reliefs. |
| swCornerTreatmentPlanarTrimOptions_e | Structure system corner treatment planar trim options. |
| swCornerTreatmentPlanarTrimToolType_e | Structure system corner treatment planar trim tool types. |
| swCornerTreatmentTrimType_e | Structure system corner treatment trim types. |
| swCornerType_e | Structure system corner types. |
...
| swCreateFeatureError_e | Error codes that may occur when creating a feature. |
...
| swDefaultBOMPartNumberSource_e | Sources of bill of materials part numbers for new configurations. |
...
| swDetailingGtolMaterialConditionSymbolPlacement_e | Tools > System Options > Document properties > Annotations > Geometric Tolerances > Material Condition Symbol Placement . |
...
| swFeatureManagerTreeViewCADFamily_e | SOLIDWORKS Connected only. Tools > System Options > FeatureManager > Select a configuration view for the FeatureManager Tree Area . |
...
| swFileSaveTo3DExperienceError_e | Errors when saving files in SOLIDWORKS Connected. |
...
| swGetOpenFileNameOptions_e | Options for opening a file returned by ISldWorks::GetOpenFileName2 . Bitmask . |
...
| swGtolDecimalSeparatorType_e | Gtol decimal separator types. |
| swGtolFormatConversionError_e | Gtol format conversion errors. |
| swGtolFormatSchemaVersion_e | Gtol format schema versions. |
| swGtolFormatType_e | Gtol format types. |
| swGtolGeomCharSymbol_e | GTol geometric character symbols. |
| swGtolIndicatorBorderType_e | Gtol indicator border types. |
...
| swInsertAssyOptions_e | Insert assembly into part options. Bitmask . |
...
| swPrimaryMemberPointLengthEndCondition_e | Structure system primary member point length end conditions. |
...
| swRegionType_e | Drawing zone region types. |
...
| swSaveWithReferencesOptions_e | Options for saving references while getting the IAdvancedSaveAsOptions object; used by the Options parameter of IModelDocExtension::GetAdvancedSaveAsOptions . Bitmask . |
...
| swSecondaryMemberBetweenPointsDistanceFromEndType_e | Distance types of structure system secondary members created between end points of primary members. |
| swSecondaryMemberUpToMembersDistanceFromEndType_e | Distance from end types for structure system secondary up-to members. |
| swSecondaryMemberUpToMembersMemberPointParameters_e | Point parameters for structure system secondary up-to members. |
...
| swSetComponentIdentifierResult_e | Set component identifier status. Bitmask . |
...
| swSheetPrintQuadrant_e | Quadrant options to print in TIFF format a high quality (zoomed) image of a drawing sheet. Used for machine learning and pixel compare tests. |
| swSheetSewingError_e | Sheet sewing errors. |
| swSheetSewingOption_e | Sheet sewing options. |
| swShowMessageBarResult_e | Message bar display result codes. |
| swShowNotificationResult_e | User notification display return values. |
...
| swSplitMemberDimensionType_e | Structure system split member dimension types. |
...
| swStructureProfileAlignmentType_e | Structure system profile alignment types. |
| swStructureProfileMirrorType_e | Structure system profile mirror types. |
| swStructureProfilePiercePointType_e | Structure profile pierce points. |
| swStructureSplitMemberType_e | Structure system split member types. |
| swStructureSystemMemberCreationType_e | Structure system member creation types. |
| swStructureSystemMemberType_e | Structure system member types. |
...
| swTrimToolMemberObjectType_e | Structure system complex corner treatment trim tools. |
...
| swUserMessageBarResponseType_e | Types of user response controls for message bars. |
| swUserMessageBarSeverity_e | Types of severities for message bars. |
| swUserNotificationPosition_e | User notification display positions. |
| swUserNotificationResponseType_e | User response controls for user notifications. |
| swUserNotificationSeverity_e | User notification severities. |
...
[SolidWorks.Interop.swconst Assembly](SolidWorks.Interop.swconst.html)
