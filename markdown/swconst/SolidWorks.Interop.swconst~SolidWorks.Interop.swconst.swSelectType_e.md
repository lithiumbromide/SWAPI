---
title: "swSelectType_e Enumeration"
project: "SOLIDWORKS API Enumerations"
interface: "swSelectType_e"
member: ""
kind: "enum"
...
| swSelectType_e | IModelDocExtension::SelectByID2 string | ISelectionMgr::GetSelectedObject6 return value | IFeature::GetSpecificFeature2 return value |
| --- | --- | --- | --- |
| swSelNOTHING |  |  |  |
| swSelEDGES | "EDGE" | IEdge |  |
| swSelFACES | "FACE" | IFace2 |  |
| swSelVERTICES | "VERTEX" | IVertex |  |
| swSelDATUMPLANES | "PLANE" | Feature 2 | IRefPlane |
| swSelDATUMAXES | "AXIS" | Feature 2 | IRefAxis |
| swSelDATUMPOINTS | "DATUMPOINT" | Feature 1 | No specific interface |
| swSelOLEITEMS | "OLEITEM" | Not Supported |  |
| swSelATTRIBUTES | "ATTRIBUTE" | Feature 1 | IAttribute |
| swSelSKETCHES | "SKETCH" | Feature 2 | ISketch |
...
| swSelSECTIONLINES | "SECTIONLINE" | Feature 1 | IDrSection |
| swSelDETAILCIRCLES | "DETAILCIRCLE" | Feature 1 | IDetailCircle |
| swSelSECTIONTEXT | "SECTIONTEXT" |  |  |
| swSelSHEETS | "SHEET" | ISheet |  |
| swSelCOMPONENTS | "COMPONENT" | IComponent2 |  |
| swSelMATES | "MATE" | Feature 2 | IMate |
| swSelBODYFEATURES | "BODYFEATURE" 3 | Feature 1 | No specific interface |
| swSelREFCURVES | "REFCURVE" | Feature 1 | IReferenceCurve |
| swSelEXTSKETCHSEGS | "EXTSKETCHSEGMENT" | ISketchSegment |  |
| swSelEXTSKETCHPOINTS | "EXTSKETCHPOINT" | ISketchPoint or origin point |  |
| swSelHELIX | "HELIX" |  |  |
| swSelREFERENCECURVES | "REFERENCECURVES" | Feature 1 | IReferenceCurve |
...
| swSelCTHREADS | "CTHREAD" | Feature or ICThread 4 | ICosmeticThreadFeatureData |
...
| swSelCONFIGURATIONS | "CONFIGURATIONS" | Feature 1 | IConfiguration |
| swSelOBJHANDLES |  |  |  |
| swSelARROWS | "VIEWARROW" | IProjectionArrow |  |
| swSelZONES | "ZONES" |  |  |
| swSelREFEDGES | "REFERENCE-EDGE" | IEdge |  |
| swSelREFFACES |  |  |  |
| swSelREFSILHOUETTE |  | Feature 1 |  |
| swSelBOMS | "BOM" |  |  |
...
| swSelCAMERAS | "CAMERAS" | Feature 1 | ICamera |
...
| swSelSWIFTANNOTATIONS | "SWIFTANN" | Feature 1 | IDimXpertAnnotation |
| swSelSWIFTFEATURES | "SWIFTFEATURE" | Feature 1 | IDimXpertFeature |
...
1Use Feature::GetSpecificFeature2 to get the interface shown in thefourthcolumn.

2Use QueryInterface to get the interface shown in thefourthcolumn.

3Use swSelWELDBEADS to select caterpillar or end-treatment weld beads in drawings. To select fillet bead features, use "BODYFEATURE" with[IModelDocExtension::SelectByID2](ms-its:sldworksapi.chm::/SOLIDWORKS.Interop.sldworks~SOLIDWORKS.Interop.sldworks.IModelDocExtension~SelectByID2.html).kadov_tag{{<spaces>}}kadov_tag{{</spaces>}}

4Feature or CThread depending on whether you select the cosmetic thread feature in a part or assembly or you select the cosmetic thread annotation in a drawing.
